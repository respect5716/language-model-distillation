...
class Model(BaseModel):
    ...
    def step(self, batch, phase):
        teacher_outputs = self.teacher(input_ids=batch.input_ids, attention_mask=batch.attention_mask, token_type_ids=batch.token_type_ids)
        student_outputs = self.student(input_ids=batch.masked_input_ids, attention_mask=batch.attention_mask, token_type_ids=batch.token_type_ids)
